...
```{code-cell}
cd $FLEXI_ROOT
cmake --preset freestream
cmake --build --preset freestream
cd tutorials/freestream
```

## Mesh Generation
In the tutorial directory, we provide the necessary mesh file, `cartbox_mesh.h5`, along with a [parameter file](../../../../tutorials/freestream/parameter_hopr.ini) for **HOPR** to generate this mesh. You can recreate the mesh by running the following command.
```{code-cell}
hopr parameter_hopr.ini
```

## Simulation Parameters
The [parameter file](../../../../tutorials/freestream/parameter_flexi.ini) to run the simulation is supplied as `parameter_flexi.ini`.  The parameters specific to the Navier-Stokes equation system can be found in the `EQUATION` section of the file.
```ini
! ============================================================ !
! EQUATION
! ============================================================ !
